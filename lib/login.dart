...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      // ),
      child: Scaffold(backgroundColor: Color.fromARGB(0, 225, 220, 220),
        appBar: AppBar(
          backgroundColor: Color.fromARGB(0, 242, 235, 235),
          elevation: 0,
        ),
        body: Stack(
          children: [
